...
//SELECT * FROM inmueble where alquiler< 5000 and tipo = 'chalet' and ciudad = 'Valencia' and habitaciones< 4
    ...
    $statement=$PDO->prepare("SELECT * FROM inmueble where venta<:dinero and venta>0 and tipo = :tipo and ciudad = :ciudad and habitaciones>= :habitaciones and vendido=0");
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-left card-text">
                            ...
                            Precio: <?php echo $objeto['venta'];?></br>
...
<div class="container m-2">
    ...
    <div class="row justify-content-around contraste">
        <a title="Volver atras" href="comprar.php">
